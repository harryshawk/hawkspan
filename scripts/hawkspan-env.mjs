...
// These values are created for one process invocation. They carry identity,
// derived paths, or testable launch context and are not user configuration.
export const HAWKSPAN_INTERNAL_RUNTIME_ENV_NAMES = Object.freeze([
  "HAWKSPAN_AUTHORIZED_REVISION_FINGERPRINT",
  "HAWKSPAN_AUTHORIZED_TRAINING_JOB_ID",
  "HAWKSPAN_BACKGROUND",
  "HAWKSPAN_CALL_ORIGIN",
  "HAWKSPAN_CALL_TIMEOUT_MS",
  "HAWKSPAN_CALL_TOOL",
  "HAWKSPAN_DURABLE_TRAINING_JOB_ID",
  "HAWKSPAN_FALLBACK_MARKER",
  "HAWKSPAN_LAUNCH_AGENTS_DIR",
  "HAWKSPAN_LOCAL_CONTROL_DISABLED",
  "HAWKSPAN_LORA_AUTOMATION",
  "HAWKSPAN_LORA_LEDGER_PATH",
  "HAWKSPAN_LORA_MANIFEST",
  "HAWKSPAN_LORA_MPS_SHIM_DIR",
  "HAWKSPAN_LORA_OUTPUT_ROOT",
  "HAWKSPAN_LORA_PACKET_BUILDER",
  "HAWKSPAN_LORA_QUEUE_ROOT",
  "HAWKSPAN_LORA_RETURN_ROOT",
  "HAWKSPAN_LORA_SOURCE_ZIP",
  "HAWKSPAN_NODE",
  "HAWKSPAN_PROBE_CAPTURE",
  "HAWKSPAN_PS",
  "HAWKSPAN_READINESS_AUDIT_PATH",
  "HAWKSPAN_RUNTIME_NODE_PATH",
  "HAWKSPAN_SERVICE_ROOT",
  "HAWKSPAN_SIMPLETUNER_QUEUE_ITEM_ID",
...
export function applyHawkspanEnv(configuration, values) {
  ...
  for (const [key, name, minimum, maximum] of [
    ["max_train_attempts", "HAWKSPAN_MAX_TRAIN_ATTEMPTS", 1, 1000],
